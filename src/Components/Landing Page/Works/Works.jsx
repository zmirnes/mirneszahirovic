...
const Works = () => {
  return (
    <section id="works" className={classes.container}>
      ...
      >
        Transforming ideas into reality, coding to create intuitive user
        experiences.
      </motion.h1>
        ...
        {works.map((work, i) => (
          ...
          >
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className={classes.workImageContainer}
            >
              <div className={classes.projectOverlay}>
                ...
                />
                <span>
                  Click or Tap to see live version of this website/app.
                </span>
              </div>
              <img
                src={work.image}
